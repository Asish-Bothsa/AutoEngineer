...
class ImplementationTask(BaseModel):
    ...
    task_description: str = Field(description="A simple, single-line description of the task to be performed on the file. Avoid quotes, newlines, or complex formatting.")
...
class CoderState(BaseModel):
    ...
    total_calls: int = Field(0, description="Total number of tool calls made by the coder agent")
    max_calls_per_task: int = Field(5, description="Maximum number of tool calls allowed per task")